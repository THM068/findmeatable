package com.findmeatable.config;

import com.findmeatable.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.findmeatable.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.findmeatable.repository.search")
